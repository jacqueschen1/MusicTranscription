...
python3 pytorch/inference.py --model_type=$MODEL_TYPE --checkpoint_path="/content/drive/MyDrive/150000_iterations_combined.pth" --audio_path="/content/drive/MyDrive/532Project/maestro_full/maestro-v2.0.0/2013/ORIG-MIDI_03_7_6_13_Group__MID--AUDIO_09_R1_2013_wav--3.wav" --cuda
# # # Calculate metrics
